defmodule Cineaste.Person do
  ...
  schema "people" do
    ...
    many_to_many(:groups, Cineaste.Group, join_through: Cineaste.GroupMembership)
  end
  ...
  def _calculate_age(%{"year" => dob_year, "month" => dob_month, "day" => dob_day}, %{
        "year" => dod_year,
        "month" => dod_month,
        "day" => dod_day
      }) do
  ...
  def _calculate_age(%{"year" => dob_year, "month" => dob_month}, %{
        "year" => dod_year,
        "month" => dod_month
      }) do
